...
class inputAddOn{
	...
	public function html(){
		...
		$this->somacontent .= '<input type="'.$this->inputType.'" class="form-control" name="'.$this->inputName.'" id="id_'.$this->inputName.'"  placeholder="'.$this->inputPlaceholder.'" '.$this->inputExtras.'/>';
