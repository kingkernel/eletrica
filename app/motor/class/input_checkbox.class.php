<?php
	...
	public function html(){
		$this->somacontent = '<div class="btn-group pull-right" data-toggle="checkbox" id="id_'.$this->name.'"><label class="btn btn-'.$this->style.'" data-toggle="checkbox"><input type="checkbox" name="'.$this->name.'"  value="'.$this->value.'" id="id_'.$this->name.'"><span class="glyphicon glyphicon-ok"></span></label></div>';
